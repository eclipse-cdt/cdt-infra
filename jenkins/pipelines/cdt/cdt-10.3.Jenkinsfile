    ...
    stage('Git Clone') {
      steps {
        container('cdt') {
          ...
          checkout([$class: 'GitSCM', branches: [[name: '*/cdt_10_3']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'CheckoutOption', timeout: 20], [$class: 'CloneOption', depth: 0, noTags: true, reference: '', shallow: false, timeout: 20]], submoduleCfg: [], userRemoteConfigs: [[url: 'https://git.eclipse.org/r/cdt/org.eclipse.cdt.git']]])
        }
      }
    }
    stage('Run build') {
