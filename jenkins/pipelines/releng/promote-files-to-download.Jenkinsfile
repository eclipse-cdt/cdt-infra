pipeline {
  agent {
    kubernetes {
      label 'promote-files-to-download-149df18'
      yaml """
apiVersion: v1
kind: Pod
spec:
  containers:
  - name: cdt
    image: quay.io/eclipse-cdt/cdt-infra-eclipse-full@sha256:951c8ff122644c7348e4d74b2a0e13d384d7e0783186056110e17f1ef7ff5075
    tty: true
    args: ["cat"]
    resources:
      requests:
